                ...
                <div class="w-full mx-auto bg-white rounded-sm border border-gray-200">
                    <header class="px-5 py-4 border-b border-gray-100 flex items-center">
                        ...
                        <div class="ml-auto space-x-2 items-center text-sm">
                            <Checkbox id="selectAll" @click="markAll(range(1, 25))" v-model="selectedAll"
                                placeholder="Select all" class="ml-auto" :binary="true" />
                            ...
                            <table class="w-full  table-auto">
                                ...
                                <tbody class="text-sm divide-y divide-gray-100">
                                    ...
                                    <tr>
                                        <td class='p-2 whitespace-nowrap'>
                                            <div class='flex items-center'>
                                                <div class='font-medium text-gray-800'>Veículos</div>
                                            </div>
                                        </td>
                                        <td class='p-2 text-center'>
                                            <Checkbox @click='markLine(range(344, 348), 6)' v-model='lineChecked'
                                                class='ml-auto' :value='6' />
                                        </td>
                                    ...
                                    <tr>
                                        <td class='p-2 whitespace-nowrap'>
                                            <div class='flex items-center'>
                                                <div class='font-medium text-gray-800'>Servicos</div>
                                            </div>
                                        </td>
                                        <td class='p-2 text-center'>
                                            <Checkbox @click='markLine(range(369, 373), 11)' v-model='lineChecked'
                                                class='ml-auto' :value='11' />
                                        </td>
                                        <td class='p-2 whitespace-nowrap text-center'>
                                    ...
                                    <tr>
                                        ...
                                        <td class="p-2 text-center">
                                            <Checkbox @click="markLine(range(1, 5), 1)" v-model="lineChecked"
                                                class="ml-auto" :value="1" />
                                        </td>
                                        <td class="p-2 whitespace-nowrap text-center">
                                        ...
                                        <td class="p-2 whitespace-nowrap text-center">
                                            <Checkbox v-model="checked" :value="5" placeholder="Selecionar todas"
                                                class="ml-auto" />
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class='p-2 text-center'>
                                            <Checkbox @click='markLine(range(21, 25), 5)' v-model='lineChecked'
                                                class='ml-auto' :value='5' />
                                        </td>
                                        <td class='p-2 whitespace-nowrap text-center'>
                                    ...
                                    <tr>
                                        ...
                                        <td class='p-2 text-center'>
                                            <Checkbox @click='markLine(range(16, 20), 4)' v-model='lineChecked'
                                                class='ml-auto' :value='4' />
                                        </td>
                                        <td class='p-2 whitespace-nowrap text-center'>
